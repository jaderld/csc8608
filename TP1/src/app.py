...
CKPT_PATH = "TP1/models/sam_vit_h_4b8939.pth"   # Assurez-vous d'avoir téléchargé les poids ici
MODEL_TYPE = "vit_h"
...
if "points" not in st.session_state:
    st.session_state["points"] = []  # liste de tuples (x, y, label)
...
st.write({"n_points": len(st.session_state["points"]), "points": st.session_state["points"]})
...
if lp is not None and lp["img_name"] == img_name:
    ...
    overlay = render_overlay(img, mask, lp["box"], alpha=0.5)
