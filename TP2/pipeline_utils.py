...
def get_device() -> str:
    # retourner "cuda" si disponible, sinon "cpu"
...
def set_scheduler(pipe, scheduler_name: str):
    # remplacer le scheduler courant par celui choisi
...
def to_img2img(text2img_pipe):
    # créer un pipeline img2img qui réutilise exactement les mêmes composants
