...
if frames:
    frames[0].save('outputs/hacked_agent.gif', save_all=True, append_images=frames[1:], duration=30, loop=0)
    print("Vidéo du nouvel agent sauvegardée sous 'outputs/hacked_agent.gif'")
